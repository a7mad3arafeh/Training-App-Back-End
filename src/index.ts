...
app.get('/appform/:id', (req, res)=> {
    ...
    connection.query('SELECT * FROM applicationform WHERE id=?', id, (err, result)=>{
        if(err){
...
app.get('/unitrainingsupervisor/:id', (req, res)=> {
    ...
    let id = req.params['id'];
    connection.query('SELECT * FROM unitrainingsupervisor WHERE id=?', id, (err, result)=>{
        if(err){
            console.log("Error: " + err);
            res.json({'Error': err});
...
app.put('/editAppForm/:id', (req, res)=>{
    ...
    connection.query(`UPDATE applicationform SET  
...
app.put('/editTasklist/:id', (req, res)=>{
    ...
    connection.query(`UPDATE tasklist SET  
